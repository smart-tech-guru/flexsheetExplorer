...
templateType,
self;
if (_this._needsCdCheck = !1, _this._lastApplyTimeStamp = 0, _this._noApplyLag = !1, _this._startingEditing = !1, _this._cellStampCounter = 0, _this._composing = !1, _this.grid = grid, _this._gridCdRef = gridCdRef, !DirectiveCellFactory._templateTypes)
{
...
}, !0), grid.hostElement.addEventListener('compositionstart', function()
{
self._composing = !0
}, !0), grid.hostElement.addEventListener('compositionend', function()
{
self._composing = !1
...
{
isUpdated = !0;
measureAttr = cell.getAttribute(wjcGrid.FlexGrid._WJS_MEASURE);
isMeasuring = measureAttr && measureAttr.toLowerCase() === 'true';
isEdit && this._baseCf.updateCell(panel, rowIndex, colIndex, cell, rng, !0);
var cellContext_1=cell[templContextProp] || {},
isForeignCell=cellContext_1.column !== col || !cellContext_1.viewRef || cellContext_1.templateContextProperty !== templContextProp || cell.firstChild != cellContext_1.rootElement,
isImeInput_1=isEdit && this._composing && grid.imeEnabled;
isForeignCell && (isEdit ? (rootEl = cell.firstElementChild, rootEl && (isImeInput_1 || cell.focus(), rootEl.style.display = 'none')) : cell.textContent = '', this._doDisposeCell(cell), templInstance = templContext._instantiateTemplate(cell), cellContext_1.column = col, cellContext_1.viewRef = templInstance.viewRef, cellContext_1.rootElement = templInstance.rootElement, cellContext_1.templateContextProperty = templContextProp, cell[templContextProp] = cellContext_1);
cellInfo_1 = this._setViewRefVars(cellContext_1.viewRef, row, col, dataItem, cellValue, templContext.valuePaths);
templContext.cellOverflow && (cell.style.overflow = templContext.cellOverflow);
isMeasuring ? templContext.cdRef.detectChanges() : templContext.autoSizeRows && !isImeInput_1 ? setTimeout(function()
{
...
isEdit && _this._initEditInput(cellContext_1, null)
}
}, 0) : isEdit && setTimeout(function()
{
isImeInput_1 ? _this._initImeEditInput(cellContext_1) : _this._initEditInput(cellContext_1, null)
}, 0);
isEdit ? (self._cellEditorVars = cellInfo_1.localVars, editEndingEH = function(s, e)
{
var activeElement,
_i,
bindNames_1,
...
{
var _this=this,
input=this._findInitialInput(cellContext),
inpSt=window.getComputedStyle(input),
inpFocusEh;
inpSt.display !== 'none' && inpSt.visibility === 'visible' && (inpFocusEh = function()
{
...
changeSelection,
caretPos_1;
value && (changeSelection = !0, caretPos_1 = input.selectionStart + value.length, input.value = value, _this._editChar = null, input.dispatchEvent(_this._evtInput), changeSelection && setTimeout(function()
{
setTimeout(function()
{
...
}, input.addEventListener('focus', inpFocusEh), input.focus())
}, DirectiveCellFactory.prototype._initImeEditInput = function(cellContext)
{
var _this=this,
imeEditor=wjcCore.getActiveElement(),
compEndEh_1,
templateInput;
if (imeEditor && imeEditor instanceof HTMLInputElement && wjcCore.hasClass(imeEditor, 'wj-grid-ime') && (compEndEh_1 = function()
{
...
}, imeEditor.addEventListener('compositionend', compEndEh_1), templateInput = this._findInitialInput(cellContext), templateInput))
{
var tRect=templateInput.getBoundingClientRect(),
...
left: imeStyleLeft + tRect.left - imeRect.left + 'px', top: imeStyleTop + tRect.top - imeRect.top + 'px', width: tRect.width + 'px', height: tRect.height + 'px'
})
}
}, DirectiveCellFactory.prototype._findInitialInput = function(cellContext)
{
var inputs=cellContext && cellContext.rootElement && cellContext.rootElement.querySelectorAll('input'),
i,
input,
inpSt;
if (inputs)
